...
# Add input for user preferences
ask_adult = input("Do you want adult content? (yes/no): ")
ask_start_year = int(input("Enter the start year (1966 - 2018): "))
ask_genre = input("Enter the genre (comedy, drama, or romance): ")

# Generate recommendations based on user input
recommendations = user_prefer_recommender(df, ask_adult, ask_start_year, ask_genre)
